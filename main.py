...
def _job_select_all():
    ...
    if "title" in info:
        return f"SELECT title, {base_cols}{date_cols}{deadline_col}{address_col}{progress_col} FROM jobs"
    if "name" in info:
        return f"SELECT name AS title, {base_cols}{date_cols}{deadline_col}{address_col}{progress_col} FROM jobs"
    return f"SELECT '' AS title, {base_cols}{date_cols}{deadline_col}{address_col}{progress_col} FROM jobs"
