import os, re, io, sqlite3, logging
...
if not SECRET_KEY:
    if os.environ.get("FLASK_ENV") == "production":
        raise ValueError("⚠️  SECRET_KEY must be set in production!")
    SECRET_KEY = "dev-" + os.urandom(16).hex()
    print("⚠️  Using default SECRET_KEY - NOT FOR PRODUCTION!")

app = Flask(__name__, static_folder=".", static_url_path="")
app.secret_key = SECRET_KEY

# Secure cookies konfigurace
app.config.update(
