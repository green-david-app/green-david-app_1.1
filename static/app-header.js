...
<header class="app-header">
  <div class="app-header-container">
    <!-- 1. ZPĚT -->
    <button class="app-header-back" id="app-header-back" type="button" onclick="history.back()" title="Zpět">
    ...
    <a href="/" class="app-header-brand">
        <img src="/static/img/logo.jpg" alt="green david app" class="app-header-logo" onerror="this.src='/static/logo.svg'"/>
        <div class="app-header-text">
            <span class="app-header-title">green david app</span>
            <span class="app-header-subtitle">interní systém</span>
        </div>
    </a>
    ...
    <div class="app-header-actions">
        <!-- 4. AI OPERÁTOR -->
        <a href="/ai-operator" class="app-header-user" title="AI Operátor">
        ...
        <!-- 5. ÚKOLY -->
        <a href="/tasks" class="app-header-user" title="Úkoly">
        ...
        <!-- 6. NOTIFIKACE -->
        <button class="app-header-user" onclick="toggleNotificationsDropdown()" title="Notifikace">
        ...
        <!-- 8. ODHLÁSIT -->
        <button class="app-header-settings" onclick="logout()">
            Odhlásit
        </button>
    </div>
  </div>
