...
class AppHeader {
  ...
  initSearch() {
    ...
    document.addEventListener('click', (e) => {
      ...
      render() {
        // Smaž jakýkoliv existující header
  ...
  <div class="app-header-container" style="overflow:hidden;">
    ...
    <!-- 5-8. Pravá strana - actions -->
    <div class="app-header-actions">

      <!-- 5. Úkoly — klikatelný odkaz na inbox -->
      <a href="/inbox.html" id="header-tasks-count" class="app-header-tasks-count" title="Moje práce">
        Úkoly: <strong>0</strong>
      </a>

      <!-- 6. AI Asistent — JEDINÁ ikona -->
      ...
      <!-- 7. Notifikace — JEDEN zvoneček -->
      <a href="/notifications.html" class="app-header-notifications" id="app-header-notifications" title="Notifikace">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    try {
      ...
      if (j.authenticated) {
        ...
        if (tasksEl) {
          ...
          tasksEl.innerHTML = `Úkoly: <strong>${count}</strong>`;
        }
