      ...
      if (!document.getElementById('bulk-actions-styles')) {
        ...
        style.textContent = `
          .bulk-actions-bar {
            ...
            border: 1px solid var(--mint, #9FD4A1);
            border-radius: 16px;
            padding: 12px 24px;
            gap: 16px;
            align-items: center;
          ...
          .bulk-btn.success { border-color: var(--mint, #9FD4A1); color: var(--mint, #9FD4A1); }
          ...
          .bulk-checkbox:hover { border-color: var(--mint, #9FD4A1); }
          ...
          .bulk-item.selected {
            border-color: var(--mint, #9FD4A1) !important;
