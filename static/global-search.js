...
class GlobalSearch {
    ...
    createSearchBar() {
        // Najdi header search container - podporuj nový unified header
        let container = document.querySelector('.app-header-search');
        let isNewHeader = false;
        
        if (container) {
            // Nový unified header - použij existující input
        ...
        if (!this.searchInput) {
            ...
            this.searchInput.id = 'app-header-search-input';
    ...
    displayResults(results, total, query) {
        ...
        if (results.jobs.length > 0) {
            ...
            html += '<h4><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg> Zakázky</h4>';
        ...
        if (results.tasks.length > 0) {
            html += '<div class="search-category">';
            html += '<h4><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 12l2 2 4-4"/></svg> Úkoly</h4>';
        ...
        if (results.issues.length > 0) {
            html += '<div class="search-category">';
            html += '<h4><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg> Issues</h4>';
        ...
        if (results.employees.length > 0) {
            html += '<div class="search-category">';
            html += '<h4><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> Team</h4>';
        ...
        html += `<a class="search-footer" href="/search?q=${encodeURIComponent(query)}">${total} výsledků – zobrazit vše</a>`;
