...
<header class="app-header">
  <div class="app-header-container">
    ...
    <a href="/" class="app-header-brand">
      <img src="/static/img/logo.png" alt="green david app" class="app-header-logo" onerror="this.onerror=null;this.src='/static/logo.svg'"/>
    ...
    <form class="app-header-search" id="app-header-search-form" role="search">
      <button class="app-header-search-toggle" id="app-header-search-toggle" type="button" title="Vyhledávání">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          <circle cx="11" cy="11" r="7"></circle>
          <path d="M20 20l-3.5-3.5"></path>
        </svg>
      </button>
      <input class="app-header-search-input" id="app-header-search-input" type="search" placeholder="Vyhledat v aplikaci…" autocomplete="off" />
    </form>
