...
class SmartNotifications {
    ...
    async init() {
        debugLog('🔔 Smart Notifications initializing...');
        ...
        debugLog('✅ Smart Notifications ready');
    }
        ...
        if ('serviceWorker' in navigator) {
            try {
                try {
                    ...
                    // Service worker není k dispozici - ignoruj
                    console.log('Service worker not available');
                }
                debugLog('ServiceWorker registered:', registration.scope);
            } catch (e) {
    ...
    async runChecks() {
        ...
        debugLog('🔍 Running notification checks...');
