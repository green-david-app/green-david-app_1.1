...
(function() {
    ...
    const navShortcuts = {
        ...
        'e': { action: () => window.location.href = '/employees.html', desc: 'Zaměstnanci' },
    ...
    function showShortcutsHelp() {
        ...
        let html = `
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                <div>
                    <h3 style="color: #9FD4A1; font-size: 14px; margin: 0 0 12px 0; text-transform: uppercase; letter-spacing: 1px;">Navigace</h3>
            ...
            html += `
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 12px; background: rgba(255,255,255,0.03); border-radius: 8px;">
                    ...
                    <div style="display: flex; gap: 4px;">
                        <kbd style="background: rgba(159, 212, 161, 0.15); border: 1px solid rgba(159, 212, 161, 0.3); border-radius: 4px; padding: 3px 6px; font-size: 11px; color: #9FD4A1; font-family: monospace;">G</kbd>
                        <kbd style="background: rgba(159, 212, 161, 0.15); border: 1px solid rgba(159, 212, 161, 0.3); border-radius: 4px; padding: 3px 6px; font-size: 11px; color: #9FD4A1; font-family: monospace;">${key.toUpperCase()}</kbd>
                    </div>
                </div>
            `;
        });
        ...
        html += `
                ...
                <div>
                    <h3 style="color: #9FD4A1; font-size: 14px; margin: 0 0 12px 0; text-transform: uppercase; letter-spacing: 1px;">Akce</h3>
                    <div style="display: flex; flex-direction: column; gap: 8px;">
        `;
        ...
        actionShortcuts.forEach(key => {
            ...
            if (shortcut && shortcut.action) {
                ...
                html += `
                    <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 12px; background: rgba(255,255,255,0.03); border-radius: 8px;">
                        <span style="color: #9ca8b3; font-size: 13px;">${shortcut.desc}</span>
                        <kbd style="background: rgba(159, 212, 161, 0.15); border: 1px solid rgba(159, 212, 161, 0.3); border-radius: 4px; padding: 3px 6px; font-size: 11px; color: #9FD4A1; font-family: monospace;">${displayKey}</kbd>
                    </div>
                `;
            }
        });
        ...
        html += `
                        <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 12px; background: rgba(255,255,255,0.03); border-radius: 8px;">
                            ...
                            <div style="display: flex; gap: 4px;">
                                <kbd style="background: rgba(159, 212, 161, 0.15); border: 1px solid rgba(159, 212, 161, 0.3); border-radius: 4px; padding: 3px 6px; font-size: 11px; color: #9FD4A1; font-family: monospace;">⌘/Ctrl</kbd>
                                <kbd style="background: rgba(159, 212, 161, 0.15); border: 1px solid rgba(159, 212, 161, 0.3); border-radius: 4px; padding: 3px 6px; font-size: 11px; color: #9FD4A1; font-family: monospace;">K</kbd>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        setTimeout(() => {
            ...
            toast.innerHTML = `
                ...
                <div>
                    ...
                    <div style="color: #9ca8b3; font-size: 12px;">Stiskni <kbd style="background: rgba(159, 212, 161, 0.2); padding: 2px 6px; border-radius: 3px; color: #9FD4A1;">?</kbd> pro zobrazení</div>
                </div>
