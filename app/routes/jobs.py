...
def api_jobs():
    ...
    if request.method == "POST":
        try:
            ...
            cols, vals = _job_insert_cols_and_vals(title, client, status, city, code, dt, note, owner_id=u["id"], party_id=party_id)
    ...
    if request.method == "PATCH":
        try:
            ...
            for f in ("client","status","city","code","date","note","created_date","start_date","progress","deadline","address","location","estimated_value","budget","party_id"):
                if f in data:
